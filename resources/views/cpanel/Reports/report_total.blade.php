...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#is_bill_no').attr('checked' , false);
        $('#bill_no').attr('disabled' , true);
        $('#is_client').attr('checked' , false);
        $('#client_id').attr('disabled' , true);
        $('#is_from_date').attr('checked' , false);
        $('#from_date').attr('disabled' , true);
        $('#is_to_date').attr('checked' , false);
        $('#to_date').attr('disabled' , true);
        $('#to_date').val(today);
        $('#from_date').val(today);
        $('#is_from_time').attr('checked' , false);
        $('#from_time').attr('disabled' , true);
        $('#is_to_time').attr('checked' , false);
        $('#to_time').attr('disabled' , true);
        $('#to_time').val(now.getHours() + ':' + now.getMinutes());
        $('#from_time').val(now.getHours() + ':' + now.getMinutes());
        $('#is_machine').attr('checked' , false);
        $('#machine_id').attr('disabled' , true);
        $('#is_shifts').attr('checked' , false);
