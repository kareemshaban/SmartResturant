...
<div @if($paper_type == 0 ) id="invoice-POS" @elseif($paper_type == 1) id="invoice-POS2" @else id="invoice-POS3" @endif >
    ...
    <div id="mid" class="info">
        <table class="hedaer_table">
          <thead>
            <tr>
                <th class="text-center tabletitle">الصنف </th>
                <th class="text-center tabletitle">الكمية الحالية</th>
                <th class="text-center tabletitle">الوحدة </th>
            ...
            @foreach( $items as $item)
                   ...
                   <tr>
                       <td class="text-center">{{Config::get('app.locale') == 'ar' ?  $item -> name_ar : $item -> name_en }}</td>
                       <td class="text-center">{{$item -> quantity}}</td>
                       <td class="text-center">{{Config::get('app.locale') == 'ar' ? $item -> unit_ar : $item -> unit_en}}</td>
                   </tr>
