    ...
    <div id="bot">
        ...
        <div id="table" class="hedaer_table">
            <table style="direction: rtl;">
                <tr >
                    <td class="tabletitle"> بداية الشيفت</td>
                    <td class="tabletitle">نهاية الشيفت</td>
                    <td class="tabletitle">المبلغ</td>

                </tr>
                    <tr class="service" >
                        <td class="tableitem"> {{$shift -> start_at }}</td>
                        <td class="tableitem">{{$shift -> end_at }}</td>
                        <td class="tableitem">{{$shift -> end_money}}</td>
                    </tr>
