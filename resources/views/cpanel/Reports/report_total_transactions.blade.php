...
<div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
    ...
    <div class="page-wrapper">
        @include('Layouts.subheader', [
            'pageTitle' => Config::get('app.locale') == 'ar' ? 'تقرير إجماليات ': 'Total Transactions Report' ])
            ...
            <div class="row justify-content-center">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-xl-8 form data-entry">
                        ...
                        <form class="center" method="POST" action="{{ route('report_total_transactions') }}" enctype="multipart/form-data">
                            <div class="card-header px-0 mt-2 bg-transparent clearfix">
                                <h4 class="float-left pt-2">{{ __('main.report_movements_total') }}</h4>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <label>{{ __('main.shift_no') }}</label>
                                        <input type="checkbox" name="is_shift" id="is_shift"/>
                                        <input type="text" name="shift_no" id="shift_no"
                                               class="form-control @error('to_date') is-invalid @enderror" autofocus  placeholder="{{__('main.shift_no') }}"/>
                                        @error('shift_no')
                                        <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
