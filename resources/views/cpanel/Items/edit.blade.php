...
<body>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
        ...
        <div class="container-fluid">
            <form class="center" method="POST" action="{{ route('updateItem' , $item -> id) }}" enctype="multipart/form-data">
                        ...
                        <div class="card-body px-0">
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" name="description_ar" id="description_ar"
                                    ...
                                    placeholder="{{ __('main.description_ar') }}" autofocus >{{ $item -> description_ar != null ?  $item -> description_ar : ''  }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" name="description_en" id="description_en"
                                    ...
                                    placeholder="{{ __('main.description_en') }}" autofocus >{{ $item -> description_en != null ?  $item -> description_en : ''  }}</textarea>
