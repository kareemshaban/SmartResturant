...
<div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
    ...
    <div class="container-fluid">
        <form class="center" method="POST" action="{{ route('updateExpenses_type' , $expenses -> id) }}" enctype="multipart/form-data">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-9 col-xl-7 data-entry">
                    <div class="card-header px-0 mt-2 bg-transparent clearfix">
                        <h4 class="float-left pt-2">{{ __('main.edit_expenses') }}</h4>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name_ar" id="name_ar"
                                           ...
                                           placeholder="{{ __('main.name_ar_place') }}" autofocus value="{{$expenses -> name_ar}}"/>
                                    @error('name_ar')
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name_en" id="name_en"
                                           ...
                                           placeholder="{{ __('main.name_en_place') }}" autofocus  value="{{$expenses -> name_en}}"/>
                                    @error('name_en')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea  name="description_ar" id="description_ar"
                                               ...
                                               placeholder="{{ __('main.description_ar') }}" autofocus> {{$expenses -> description_ar}} </textarea>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="description_en" id="description_en"
                                              ...
                                              placeholder="{{ __('main.description_en') }}" autofocus> {{$expenses -> description_en}} </textarea>
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control-cehck  @error('show_bill_number') is-invalid @enderror" type="checkbox"
                                           id="show_bill_number" name="show_bill_number"  @if($expenses -> show_bill_number == 1) checked @endif>
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control-cehck  @error('show_supplier_name') is-invalid @enderror" type="checkbox"
                                           id="show_supplier_name" name="show_supplier_name"   @if($expenses -> show_supplier_name == 1) checked @endif>
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control-cehck  @error('show_tax_number') is-invalid @enderror" type="checkbox"
                                           id="show_tax_number" name="show_tax_number"  @if($expenses -> show_tax_number == 1) checked @endif>
