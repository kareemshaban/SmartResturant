...
>
    ...
    @include('layout.side' , ['slag' => 10 , 'subSlag' => 105])
    <div class="page-wrapper   @if(Config::get('app.locale') == 'ar') right @else  left  @endif ">
        @include('layout.cramp' , ['page_Title' => __('main.marital_status') , 'menue' => __('main.side_basic') ])
    ...
    @include('cpanel.MartialStatus.create')
    @include('deleteModal')
</div>
...
<script type="text/javascript">
    ...
    function confirmDelete(){
        let url = "{{ route('destroyMaritalStatus', ':id') }}";
