...
<body>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
        ...
        @include('Layouts.subheader', [
                'pageTitle' => Config::get('app.locale') == 'ar' ? 'الحالة الاجتماعية' : 'Martial Status',
        ])
        <div class="container-fluid">
            <form class="center" method="POST" action="{{ route('updateMaritalStatus', $maritalStatus->id) }}"
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-9 col-xl-7 data-entry">
                        <div class="card-header px-0 mt-2 bg-transparent clearfix">
                            <h4 class="float-left pt-2">{{ __('main.edit_martial') }}</h4>
