                        ...
                        <tbody>
                            @foreach ($printers as $printer)
                             <tr>
                              ...
                              <td class="text-center">
                                <a href= "{{route('editPrinter' , $printer -> id)}}">    <button type="button" class="btn btn-success"><i class="fas fa-edit"></i></button> </a>
                                <a onclick="return confirm('Are you sure?')" href= "{{route('destroyPrinter' , $printer -> id)}} ">  <button type="button" class="btn btn-danger"><i class="far fa-trash-alt"></i></button> </a>
                              </td>
                              </tr>
