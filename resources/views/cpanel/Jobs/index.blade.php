...
>
    ...
    @include('layout.side' , ['slag' => 10 , 'subSlag' => 106])
    <div class="page-wrapper   @if(Config::get('app.locale') == 'ar') right @else  left  @endif ">
        @include('layout.cramp' , ['page_Title' => __('main.jobs_title') , 'menue' => __('main.side_basic') ])
                            ...
                            <table id="table" class="table table-striped table-bordered" style="width:100%">
                                ...
                                @foreach ($jobs as $job)
                                    <tr>
                                        ...
                                        <td class="text-center">{{ $job->name_ar }}</td>
                                        <td class="text-center">{{ $job->name_en }}</td>
                                        <td class="text-center">
                                            <button type="button" class="btn btn-success editBtn" value="{{$job -> id}}"><i
                                                    class="fas fa-edit"></i></button>

                                            <button type="button" class="btn btn-danger deleteBtn" value="{{$job -> id}}"><i
