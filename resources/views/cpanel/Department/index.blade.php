...
>
    ...
    @include('layout.side' , ['slag' => 10 , 'subSlag' => 102])
    <div class="page-wrapper   @if(Config::get('app.locale') == 'ar') right @else  left  @endif ">
        @include('layout.cramp' , ['page_Title' => __('main.department_title') , 'menue' => __('main.side_basic') ])
                            ...
                            <table id="table" class="table table-striped table-bordered" style="width:100%">
                                ...
                                @foreach ($departments as $department)
                                    <tr>
                                       ...
                                       <button type="button" class="btn btn-success editBtn" value="{{$department -> id}}"><i
                                                        class="fas fa-edit"></i></button>
                                         <button type="button" class="btn btn-danger deleteBtn"  value="{{$department -> id}}" ><i
...
<script type="text/javascript">
    ...
    function confirmDelete(){
        let url = "{{ route('destroyDepartment', ':id') }}";
