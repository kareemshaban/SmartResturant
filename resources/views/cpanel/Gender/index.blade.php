...
>
    ...
    @include('layout.side' , ['slag' => 10 , 'subSlag' => 103])
    <div class="page-wrapper   @if(Config::get('app.locale') == 'ar') right @else  left  @endif ">
        @include('layout.cramp' , ['page_Title' => __('main.gender_title') , 'menue' => __('main.side_basic') ])
                                ...
                                @foreach ($genders as $gender)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                             <button type="button" value="{{$gender -> id}}" class="btn btn-success editBtn"><i class="fas fa-edit"></i></button>
                                        <button
                                                    type="button" class="btn btn-danger deleteBtn " value="{{$gender->id}}"><i
...
<script type="text/javascript">
    ...
    function confirmDelete(){
        let url = "{{ route('destroyGender', ':id') }}";
