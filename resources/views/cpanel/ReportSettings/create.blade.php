...
<div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
    ...
    <div class="container-fluid">
        ...
        <form class="center" method="POST" action="{{ route('storeReportSetting') }}" enctype="multipart/form-data">

            <div class="row justify-content-center">
                @csrf
                <!-- {{ csrf_field() }} -->
                <div class="col-md-9 col-xl-7 c data-entry">
                    ...
                    <div class="card-body px-0">
                        <div class="form-group">
                            ...
                            <textarea class="wysihtml5 form-control" name="header_ar" placeholder="{{__('main.header_ar')}}" rows="3"> </textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="wysihtml5 form-control" name="header_en" placeholder="{{__('main.header_en')}}" rows="3"> </textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="wysihtml5 form-control" name="footer_ar" placeholder="{{__('main.footer_ar')}}" rows="3"> </textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="wysihtml5 form-control" name="footer_en" placeholder="{{__('main.footer_en')}}" rows="3"> </textarea>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" id="logo"   name="logo"  accept="image/png, image/jpeg" required>
