                ...
                <div class="row justify-content-center" style="padding-bottom: 50px;"> 
                    ...
                    <div class="col-md-9 col-xl-9" >
                        <div class="card-header px-0 mt-2 bg-transparent clearfix">
                            <h4 class="float-left pt-2">{{ __('main.new_employee') }}</h4>
                        ...
                        <h2 class="text-center">{{ __('main.side_basic') }} </h2>
                        ...
                        <h2 class="text-center">{{ __('main.work_data') }} </h2>
                        <div class="row">
                            <div class="col-6">
                             <div class="form-group">
                        ...
                        <div class="row">
                         ...
                         <h2 class="text-center">{{ __('main.contact_data') }} </h2>
