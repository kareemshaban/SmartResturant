...
>
    ...
    @include('layout.side' , ['slag' => 10 , 'subSlag' => 101])
    <div class="page-wrapper   @if(Config::get('app.locale') == 'ar') right @else  left  @endif ">
        @include('layout.cramp' , ['page_Title' => __('main.religion_title') , 'menue' => __('main.side_basic') ])
                            ...
                            <table id="table" class="table table-striped table-bordered" style="width:100%">
                                ...
                                @foreach ($religions as $religion)
                                    <tr>
                                        ...
                                        <td class="text-center">{{$religion -> id}}</td>
                                        <td class="text-center">{{$religion -> name_ar}}</td>
                                        <td class="text-center">{{$religion -> name_en}}</td>
                                        <td class="text-center">
                                            <button type="button" class="btn btn-success editBtn" value="{{$religion -> id}}"><i class="fas fa-edit"></i></button>
                                             <button type="button" class="btn btn-danger deleteBtn" value="{{$religion -> id}}"><i class="far fa-trash-alt"></i></button>
                                        </td>
                                    </tr>
    ...
    @include('cpanel.Religions.create')
    @include('deleteModal')
</div>
...
<script type="text/javascript">
    ...
    function confirmDelete(){
        let url = "{{ route('destroyReligion', ':id') }}";
