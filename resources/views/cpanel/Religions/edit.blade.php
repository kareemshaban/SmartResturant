...
<body>
    ...
    data-sidebar-position="absolute" data-header-position="absolute" data-boxed-layout="full">
        ...
        @include('Layouts.subheader' , ['pageTitle' =>  Config::get('app.locale') == 'ar'? 'الديانات' : 'Religions'])
        <div class="container-fluid">
            <form class="center" method="POST" action="{{ route('updateReligion' , $religion -> id) }}" enctype="multipart/form-data" >
                    ...
                    <div class="card-body px-0">
                      <div class="form-group">
                        ...
                        <input
                          ...
                          placeholder="{{__('main.name_ar_place')}}"
                          autofocus
                          value="{{$religion -> name_ar}}"
                        />
                        @error('name_ar')
                      ...
                      <div class="form-group">
                        ...
                        placeholder="{{__('main.name_en_place')}}"
                        autofocus
                        value="{{$religion -> name_en}}"
                      />
                      @error('name_en')
                      <span class="invalid-feedback" role="alert">
                          <strong>{{ $message }}</strong>
