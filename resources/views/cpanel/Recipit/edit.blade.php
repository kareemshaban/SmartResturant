...
<div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
    ...
    <div class="container-fluid">
        <form class="center" method="POST" action="{{ route('updateRecipt' , $bill -> id) }}" enctype="multipart/form-data">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-7 col-xl-7 form data-entry">
                    <div class="card-header px-0 mt-2 bg-transparent clearfix">
                        <h4 class="float-left pt-2">{{ __('main.edit_recipit') }}</h4>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="bill_number" id="bill_number"
                                           ...
                                           placeholder="{{ __('main.doc_number') }}" autofocus readonly value="{{$bill -> bill_number }}"/>
                                    @error('bill_number')
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="custom-select mr-sm-2 @error('doc_type') is-invalid @enderror"
                                        ...
                                        @foreach ($expenses as $item)
                                            <option value="{{$item -> id}}" @if($bill -> doc_type == $item -> id) selected @endif >
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <select class="custom-select mr-sm-2 @error('tax_type') is-invalid @enderror"
                                        ...
                                        <option  value="1" @if($bill -> tax_type == 1) selected @endif>{{__('main.tax_type1')}}</option>
                                        <option  value="2" @if($bill -> tax_type == 2) selected @endif>{{__('main.tax_type2')}}</option>
                                    </select>
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="any" name="amount" id="amount"
                                           ...
                                           placeholder="{{ __('main.amount') }}" autofocus onkeyup="amountChange(this)" value="{{$bill -> amount}}"/>
                                    @error('amount')
                                    <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" step="any" name="tax" id="tax"
                                           ...
                                           placeholder="{{ __('main.tax') }}" autofocus readonly value="{{$bill -> tax}}"/>
                                    <input type="text" step="any" name="taxPer" id="taxPer"
                                           class="form-control" @if($bill -> tax > 0)  value="{{($bill -> tax / $bill -> amount) * 100 }}"   @else value="0"   @endif
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="any" name="amount_with_tax" id="amount_with_tax"
                                           ...
                                           placeholder="{{ __('main.amount_tax') }}" autofocus readonly value="{{$bill -> amount_with_tax}}"/>
                            ...
                            <div class="col-4" id="show_bill_number">
                                <div class="form-group">
                                    ...
                                    <input type="text"  name="bill_number_txt" id="bill_number_txt"
                                           ...
                                           placeholder="{{ __('main.bill_number_txt') }}" autofocus value="{{$bill -> bill_number_txt}}"/>
                            ...
                            <div class="col-4" id="show_tax_number">
                                <div class="form-group">
                                    ...
                                    <input type="text"  name="tax_number_txt" id="tax_number_txt"
                                           class="form-control @error('tax') is-invalid @enderror"
                                           placeholder="{{ __('main.tax_number_txt') }}" autofocus  value="{{$bill -> tax_number_txt}}"/>
                            ...
                            <div class="col-4" id="show_supplier_name">
                                <div class="form-group">
                                    ...
                                    <input type="text"  name="supplier_name_txt" id="supplier_name_txt"
                                           ...
                                           placeholder="{{ __('main.supplier_name_txt') }}" autofocus value="{{$bill -> supplier_name_txt}}"/>
